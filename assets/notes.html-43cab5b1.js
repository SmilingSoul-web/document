import{_ as p,r as t,o as e,c as o,b as n,d as c,e as l,a as s}from"./app-996c2cb0.js";const i={},r=s(`<h1 id="_2024-4-17" tabindex="-1"><a class="header-anchor" href="#_2024-4-17" aria-hidden="true">#</a> 2024/4/17</h1><p>css属性：</p><ol><li>pointer-events: none; //禁止鼠标选中</li><li>user-select: none; //禁止拖拽</li><li>cursor: pointer; //小手</li></ol><p>代码块 \` //激活选项卡 const setActiveTab = () =&gt; { activeTab.value = route.path //因为el-tab-pane的name是item.path，所以activeTab也是path }</p><pre><code>watch(() =&gt; route.path, () =&gt; {
	//激活选项卡
	setActiveTab()
	//监听路由的变化
	addTabs()
...
const toggleCollapse = function() {
...
</code></pre><h1 id="前端滑动验证组件" tabindex="-1"><a class="header-anchor" href="#前端滑动验证组件" aria-hidden="true">#</a> 前端滑动验证组件</h1><p>vue3-puzzle-vcode</p><h1 id="appid-wx6562ff54366bcd2e" tabindex="-1"><a class="header-anchor" href="#appid-wx6562ff54366bcd2e" aria-hidden="true">#</a> appID:wx6562ff54366bcd2e</h1><p>项目本地运行：打包路径配置 config publicPath: p<wbr>rocess.env.NODE_ENV === &#39;production&#39; ? &#39;./&#39; : &#39;/&#39;,</p><h2 id="解释" tabindex="-1"><a class="header-anchor" href="#解释" aria-hidden="true">#</a> 解释</h2><p>这是一个三元条件运算符（ternary operator）表达式，用来根据不同的条件返回两种可能的值。在这个上下文中，它检查环境变量 p<wbr>rocess.env.NODE_ENV 是否等于字符串 &#39;production&#39;： 如果是（===），则设置 publicPath 为 &#39;./&#39;，表示资源相对于当前 HTML 页面的相对路径。 如果不是，则设置 publicPath 为 &#39;/&#39;，表示资源位于服务器的根目录下。 3. p<wbr>rocess.env.NODE_ENV 的意义 p<wbr>rocess.env.NODE_ENV 是一个环境变量，通常用于标识当前的应用程序运行环境。在 Node.js 和 Webpack 中，常见的取值包括 &#39;development&#39;（开发环境）和 &#39;production&#39;（生产环境）。这个变量有助于开发者针对不同的环境配置不同的构建行为、优化策略以及资源路径等。 综上所述，这段配置的作用如下： 当应用处于 生产环境（p<wbr>rocess.env.NODE_ENV === &#39;production&#39;），设置 publicPath 为 &#39;./&#39;。这意味着在部署到生产服务器后，浏览器会假设所有的静态资源与 HTML 文件位于同一目录下，或者具有相同的基路径。这种设置适用于资源文件被部署到与 HTML 文件紧密关联的目录结构中，例如静态资源被打包并放置在与 HTML 相同的服务器路径下。 当应用处于 非生产环境（通常是开发环境），设置 publicPath 为 &#39;/&#39;。此时，浏览器会从服务器的根路径开始寻找静态资源。这种设置常见于开发过程中，当使用诸如 Webpack Dev Server 之类的工具时，它会为本地开发提供一个虚拟的服务器环境，所有资源都通过特定端口（如 http://localhost:8080/）访问。将 publicPath 设置为 &#39;/&#39; 可确保开发过程中资源请求指向正确的开发服务器地址。 通过这样的条件判断，该配置确保了在不同环境中，静态资源都能够被正确地定位和加载，从而保证应用的正常运行。实际使用时，需要确保在构建项目时正确设置了 p<wbr>rocess.env.NODE_ENV 的值，以匹配相应的环境配置。</p><p>\`\`</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">circleChartLoad</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">i<span class="token punctuation">,</span> val<span class="token punctuation">,</span> name<span class="token punctuation">,</span> status</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),u={href:"https://github.com/ecomfe/echarts-for-weixin",target:"_blank",rel:"noopener noreferrer"},k=s(`<h3 id="_2024-06-07" tabindex="-1"><a class="header-anchor" href="#_2024-06-07" aria-hidden="true">#</a> 2024/06/07</h3><h5 id="token无感刷新-一次登陆请求" tabindex="-1"><a class="header-anchor" href="#token无感刷新-一次登陆请求" aria-hidden="true">#</a> token无感刷新+一次登陆请求</h5><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> isRefreshing <span class="token operator">=</span> <span class="token boolean">false</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">error</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function d(v,m){const a=t("ExternalLinkIcon");return e(),o("div",null,[r,n("p",null,[n("a",u,[c("ecomfe/echarts-for-weixin"),l(a)])]),k])}const y=p(i,[["render",d],["__file","notes.html.vue"]]);export{y as default};
